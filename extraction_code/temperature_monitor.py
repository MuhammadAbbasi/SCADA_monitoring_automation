...
def extract_temperature_data(page):
    ...
    try:
        ...
        logger.warning("Could not toggle 'Valori in minuti' for Temperatura.")
    ...
    try:
        ...
        logger.warning("No data rows found for Temperatura.")
        return pd.DataFrame()
    ...
    logger.info(f"Temperature Headers: {header_texts}")
